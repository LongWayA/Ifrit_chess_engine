...
//------------------------------------------------------
// распознаем повторение ходов(по моему уже не работает но проверить никак руки не доходят)
...
// обнаруживаем повторение хода движком
//cout<<"1111111111111111111" << "\n";
//		if((pv_current->initial_position[0]==three_moves->final_position [2])&&(pv_current->final_position[0]==three_moves->initial_position[2])){
