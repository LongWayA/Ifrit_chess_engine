...
for (int j=start;(!((((list_surplus_moves->move[j]>>12)& 63)==hash_moves[key].initial_position)&&(((list_surplus_moves->move[j]>>18)& 63)==hash_moves[key].final_position))&&(j<list_surplus_moves->end_list[depth]));j++);	
