...
inline void KONTROL_captures_W(const T_Bitboard * bitboard,const int * from,const int * to,const int * p,int name_figure){
#if KONTROL_B
///////////////////////////////////////////////////////////////////////////////////
...
inline void KONTROL_captures_B(const T_Bitboard * bitboard,const int * from,const int * to,const int * p,int name_figure){
#if KONTROL_B
///////////////////////////////////////////////////////////////////////////////////
if ((*p<0)||(*p>252595))   cout << "ERROR Generator_captures p= "   << *p    << "\n";
if ((*from<0)||(*from>63)) cout << "ERROR Generator_captures from= "<< *from << "\n";
...
static inline void list_record_w(int name,int d_m,int & p,int & from,unsigned __int64 & captures_mask,const T_Bitboard * bitboard,T_list_surplus_moves * list_surplus_moves){
...
// две функции только из за разного контроля списков(строки взятия)
static inline void list_record_b(int name,int d_m,int & p,int & from,unsigned __int64 & captures_mask,const T_Bitboard * bitboard,T_list_surplus_moves * list_surplus_moves){
int to = 0; // координата поля куда фигура ходит
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  while (captures_mask !=0){
     to = first_one(captures_mask);
...
//	===================================================================
// заполняем список ходов
static inline void list_record_m(int name,int d_m,int & p,int & from,unsigned __int64 & move_mask,const T_Bitboard * bitboard,T_list_surplus_moves * list_surplus_moves){
int to = 0; // координата поля куда фигура ходит
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   while (move_mask !=0){
...
//-------------------------------------------------------------------------------
  ...
  //   list_surplus_moves->name_figure[p]=name;
	 ...
	 //list_surplus_moves->final_position[p] = to;
	 //list_surplus_moves->description_move[p] =d_m; 
  //   list_surplus_moves->name_taking_figure[p] = 0;
     p=p+1;
   }//while (move !=0){
}//
//	*******************************************************************
...
static inline void list_record_os(int name,int d_m,int & p,int & from,int to,int capture,T_list_surplus_moves * list_surplus_moves){
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#if KONTROL_B
  if ((depth<0)||(depth>100)) cout << "ERROR Generator_captures depth= "<< depth << "\n";
#endif//KONTROL_B
...
// используем старые списки. после отладки и написания реализатора перейдем на новые
 ...
 p = list_surplus_moves->end_list[depth];
#if KONTROL_B
     if ((depth<0)||(depth>100)) cout << "ERROR Generator_move depth= "<< depth << "\n";
#endif//KONTROL_B
...
static inline int White_check_square(int sq, const T_Bitboard * bitboard){
...
static inline int Black_check_square(int sq, const T_Bitboard * bitboard){
