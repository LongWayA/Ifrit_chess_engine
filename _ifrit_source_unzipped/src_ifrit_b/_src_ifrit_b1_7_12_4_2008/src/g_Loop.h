...
//---------------------------------------------------------------------------
//                 доска,                список избыточных ходов,                  альфа,    бета,    максимальная глубина, глубина перебора, счетчик узлов,цепочка ходов при спуске в глубину, лучший вариант, тип хода, ничья повтором, флаг выхода, флаг шаха, флаг нулевого хода
...
void Extension_for_captures(int description_move,int description_move_up,int depth_max,int & depth_max_new,int depth);
