...
hash_moves[key].initial_position =list_surplus_moves->initial_position[i];
hash_moves[key].final_position   =list_surplus_moves->final_position[i];
...
}//Save_hash_key(short int i,T_list_surplus_moves * list_surplus_moves,T_board_list_816 * board_list_816,T_hash_moves * hash_moves){
//	*******************************************************************
...
// смотрим не встречалась ли нам такая позиция если встречалась то ее ход смотрим первым
  ...
  }// Look_hash(T_list_surplus_moves * list_surplus_moves,int key,short int depth){
//	*******************************************************************
...
short int name_figure=0;// имя фигуры которой ходим
short int  initial_position=0;// начальная координата хода
short int  final_position=0;//   конечная координата хода
short int  colour_figure=0;// цвет фигуры которой ходим

key_mem = bitboard->hash_key;
name_figure = list_surplus_moves->name_figure[i];
initial_position=list_surplus_moves->initial_position[i];
final_position=list_surplus_moves->final_position[i];
...
}//void Modification_up_random_key(short int i,T_list_surplus_moves * list_surplus_moves,T_board_list_816 * board_list_816){
//	*******************************************************************
...
}//void Modification_down_random_key(short int i,T_list_surplus_moves * list_surplus_moves,T_board_list_816 * board_list_816){
//	*******************************************************************
...
insert_hash = 0;
int start = list_surplus_moves->start_list[depth];

// 1 ищем хеш ход в списке
for (short int j=start;(!((list_surplus_moves->initial_position[j]==hash_moves[key].initial_position)&&(list_surplus_moves->final_position[j]==hash_moves[key].final_position))&&(j<list_surplus_moves->end_list[depth]));j++);	
