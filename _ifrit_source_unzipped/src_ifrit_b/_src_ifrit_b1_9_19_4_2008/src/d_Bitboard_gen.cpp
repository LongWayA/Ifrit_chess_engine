...
// находим координаты взятий короля  
  while (captures_mask !=0){
     ...
     captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
KONTROL_captures_W(bitboard,&from,&to,&p,6);
#endif//KONTROL_B
...
// находим координаты взятий ферзя
 if(captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
 KONTROL_captures_W(bitboard,&from,&to,&p,5);
#endif//KONTROL_B
...
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 if(captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
 KONTROL_captures_W(bitboard,&from,&to,&p,4);
#endif//KONTROL_B
...
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 if(captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
 KONTROL_captures_W(bitboard,&from,&to,&p,3);
#endif//KONTROL_B
...
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  while(captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
 KONTROL_captures_W(bitboard,&from,&to,&p,2);
#endif//KONTROL_B
...
// находим координаты взятий пешки 
 while (captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
 KONTROL_captures_W(bitboard,&from,&to,&p,100);
#endif//KONTROL_B
...
// превращение в ладью 14,превращение в коня 12,превращение в слона 13,превращение в ферзь 15,
      ...
      list_surplus_moves->name_taking_figure[p] = 0;
      p=p+1;
 //KONTROL_captures_W(bitboard,&from,&to,&p,110);
#if KONTROL_B
...
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  while (captures_mask !=0){
     ...
     captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
KONTROL_captures_B(bitboard,&from,&to,&p,6);
#endif//KONTROL_B
     list_surplus_moves->name_figure[p]=6 ;
	 list_surplus_moves->initial_position[p] = from;
	 list_surplus_moves->final_position[p] = to;
...
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 if(captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
KONTROL_captures_B(bitboard,&from,&to,&p,5);
#endif//KONTROL_B
     list_surplus_moves->name_figure[p]=5 ;
	 list_surplus_moves->initial_position[p] = from;
	 list_surplus_moves->final_position[p] = to;
...
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 if(captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
KONTROL_captures_B(bitboard,&from,&to,&p,4);
#endif//KONTROL_B
     list_surplus_moves->name_figure[p]=4 ;
	 list_surplus_moves->initial_position[p] = from;
	 list_surplus_moves->final_position[p] = to;
...
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 if(captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
KONTROL_captures_B(bitboard,&from,&to,&p,3);
#endif//KONTROL_B
     list_surplus_moves->name_figure[p]=3;
	 list_surplus_moves->initial_position[p] = from;
	 list_surplus_moves->final_position[p] = to;
...
// Заполняем список ходов+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 while (captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
KONTROL_captures_B(bitboard,&from,&to,&p,2);
#endif//KONTROL_B
     list_surplus_moves->name_figure[p]=2;
	 list_surplus_moves->initial_position[p] = from;
	 list_surplus_moves->final_position[p] = to;
...
// находим координаты взятий пешки 
 while (captures_mask !=0){
    ...
    captures_mask = captures_mask & (captures_mask-1);
#if KONTROL_B
KONTROL_captures_B(bitboard,&from,&to,&p,100);
#endif//KONTROL_B
     list_surplus_moves->name_figure[p]=1;
	 list_surplus_moves->initial_position[p] = from;
	 list_surplus_moves->final_position[p] = to;
...
// превращение в ладью 14,превращение в коня 12,превращение в слона 13,превращение в ферзь 15,
      ...
      list_surplus_moves->name_taking_figure[p] = 0;
      p=p+1;
//KONTROL_captures_B(bitboard,&from,&to,&p,110);
#if KONTROL_B
KONTROL_move(&from,&to,&p);
#endif//KONTROL_B
   }//while (captures !=0){
