...
// рекурсивный вызов функции
 ...
 list_surplus_moves->current_depth =depth;
	...
	// рекурсивный вызов функции
	value=Black(bitboard,list_surplus_moves,(alpha),(alpha+1),depth_max_z,(depth+1),nodes,pv_current,pv_best,list_surplus_moves->description_move[i],three_moves,br,for_chek_l,null_m);
	list_surplus_moves->current_depth =depth;
...
// рекурсивный вызов функции
 ...
 list_surplus_moves->current_depth =depth;
	...
	// рекурсивный вызов функции
	value=White(bitboard,list_surplus_moves,(beta-1),(beta),depth_max_z,(depth+1),nodes,pv_current,pv_best,list_surplus_moves->description_move[i],three_moves,br,for_chek_l,null_m);
	list_surplus_moves->current_depth =depth;
    if ((value > alpha)&&(value < beta)){
//	if (value < beta){
	// рекурсивный вызов функции
