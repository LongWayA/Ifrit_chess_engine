...
// получаем позицию и глубину перебора chess_board,Depth_Max
 Deepening(bitboard,&list_surplus_moves,depth,three_position,three_moves,nodes,wtime,btime,winc,binc,movestogo,movetime,infinite);
