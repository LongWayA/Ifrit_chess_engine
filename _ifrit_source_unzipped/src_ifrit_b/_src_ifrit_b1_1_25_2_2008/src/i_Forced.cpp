...
int Forced_variant_816(T_Bitboard * bitboard,T_list_surplus_moves * list_surplus_moves,int alpha,int beta,short int depth,T_PV * pv_current,T_PV * pv_best){
int value=0; //
int value_best=9999999; //
short int inv=0;   //
short int z=1;
short int number_taking=0;// количество взятий в списке возможных ходов
...
number_taking=list_surplus_moves->end_captures[depth];
Sorting_captures_moves(list_surplus_moves,number_taking,depth);
...
// максимальная глубина,глубина перебора,доска,
#if TEST_F
void List_816_Print_F(short int depth,const T_list_surplus_moves * list_surplus_moves){
