 ...
 * a_main, b_Protokol_UCI, b_structure, c_FEN, d_Move_816, d_Rules_816, 
 */
//---------------------------------------------------------------------------

//	===================================================================
// разбираем входящие UCI команды от графической шахматной оболочки
// аргументы :входящая строка, строка повторов ходов, доска(138)
...
//	===================================================================
//TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
// печатаем позицию полученную после разбора фен строки
#if TEST_P
