...
void Onward_moves( int i,T_list_surplus_moves * list_surplus_moves,T_Bitboard * bitboard){
...
//	===================================================================
//
void Backs_moves( int i,const T_list_surplus_moves * list_surplus_moves,T_Bitboard * bitboard){
 int depth =list_surplus_moves->current_depth;
int i_p = 0;
int f_p = 0;
