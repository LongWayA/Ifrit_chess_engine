...
hash_moves[key].move = list_surplus_moves->move[i];
...
for (int j=start;(!((((list_surplus_moves->move[j]>>12)& 63)==((hash_moves[key].move>>12)& 63))&&(((list_surplus_moves->move[j]>>18)& 63)==((hash_moves[key].move>>18)& 63)))&&(j<list_surplus_moves->end_list));j++);
