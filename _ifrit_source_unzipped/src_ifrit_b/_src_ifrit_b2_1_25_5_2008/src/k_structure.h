...
//---------------------------------------------------------------------------
// эта структура нужна реализатору ходов для восстановления позиции после хода
struct T_undo {
// флаг возврата взятия на проходе 1/0
int  return_taking_passage;
// стало возможно не разделять за белых и черных потому что у меня отдельные функции для черных и белых
// флаг рокировки в длинную сторону
int  return_castling_q;
// флаг рокировки в короткую сторону
