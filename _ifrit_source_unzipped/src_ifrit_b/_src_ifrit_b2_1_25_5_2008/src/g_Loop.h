...
//---------------------------------------------------------------------------
//                  доска,                список избыточных ходов,                  альфа,    бета,    максимальная глубина, глубина перебора, счетчик узлов,цепочка ходов при спуске в глубину, лучший вариант, тип хода, ничья повтором, флаг выхода, флаг нулевого хода
int Black(int check,struct T_Bitboard * bitboard,int alpha,int beta, int depth_max, int depth,int & nodes,struct T_PV * pv_current,T_PV * pv_best, int description_move,struct T_three_moves * three_moves, int & br,int null_m);
