...
void Modification_up_random_key(int i,T_list_surplus_moves * list_surplus_moves,T_Bitboard * bitboard){
...
void Modification_down_random_key(int i,T_list_surplus_moves * list_surplus_moves,T_Bitboard * bitboard){
int key=0; // скорректированный хеш ключ
int key_mem=0;// начальный хеш ключ
int name_figure=0;// имя фигуры которой ходим
int  initial_position=0;// начальная координата хода
