...
#ifndef A_HEADER_CONSTANTS_H
#define A_HEADER_CONSTANTS_H


/// Константы которые использую в заголовочных файлах.
namespace A_HEADER_CONSTANTS_CONSTANTS
{
...
using namespace A_HEADER_CONSTANTS_CONSTANTS;

#endif // !defined A_HEADER_CONSTANTS_H
