...
__int32 d_Search_root::white_root
(
...
//-----------------------------------------------
		...
		search.extension_for_chek_white(position,depth_max,depth_max_new,flag_check);
...
// выделил из за печати информации в оболочку. поскольку делаем это только на нулевом уровне
__int32 d_Search_root::black_root
(
	struct Position & position,// представление доски
	const __int32 alpha,//
	__int32 beta,// 
...
#if (EXTENSION_CHEK && SAVE_LINE)
		// если король под шахом то увеличиваем максимальную глубину перебора 
		search.extension_for_chek_black(position,depth_max,depth_max_new,flag_check);
#endif//#if EXTENSION_CHEK
//-----------------------------------------------
...
struct PV_line & d_Search_root::get_pv_best()
{
...
__int64 d_Search_root::get_nodes()
{
...
void d_Search_root::set_nodes_in_0()
{
...
//	===================================================================
// откуда делается ход
unsigned __int8 d_Search_root::get_from()
{
	return from;
}
...
//	===================================================================
// куда делается ход
unsigned __int8 d_Search_root::get_to()
{
	return to;
}
