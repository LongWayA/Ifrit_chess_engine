...
)
{
	...
	unsigned __int64 save_all_black_piece;
	...
	*/
	...
	// запоминаем фигуры до резки
	save_all_black_piece = position.all_black_piece;
...
)
{
...
#if DELTA_PRUNING
	/// запоминаем фигуры до резки
	unsigned __int64 save_all_white_piece;
#endif //#if DELTA_PRUNING
	...
	// запоминаем фигуры до резки
	save_all_white_piece = position.all_white_piece;
