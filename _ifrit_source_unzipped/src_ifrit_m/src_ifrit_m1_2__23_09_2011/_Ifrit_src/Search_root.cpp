...
//-----------------------------------------------
		...
		Search::extension_for_chek_white(position,depth_max,depth_max_new,flag_check,CHECK_NO);
...
#if (EXTENSION_CHEK && SAVE_LINE)
		// если король под шахом то увеличиваем максимальную глубину перебора 
		Search::extension_for_chek_black(position,depth_max,depth_max_new,flag_check,CHECK_NO);
#endif//#if EXTENSION_CHEK
//-----------------------------------------------
