...
//Test_History << "depth= "<< int(depth) << std::endl;
//Test_History << "delta_depth= "<< int(delta_depth) << std::endl;
...
//Test_History << "white_history[" << int(name) << "][" << int(to) << "]= " << white_history[name][to] << std::endl;
...
)
{
	...
	Test_History << "печатаем массивы"<< std::endl;
	Test_History <<"depth_max= "<< int(depth_max) << std::endl;

	for (unsigned __int8  i = 0; i < MAX_NAME; i++)
	{
		for (unsigned __int8  j = 0; j < MAX_COORDINATE; j++)
		{
			Test_History << "white_history[" << int(i) << "][" << int(j) << "]= " << white_history[i][j] << std::endl;
			Test_History << "black_history[" << int(i) << "][" << int(j) << "]= " << black_history[i][j] << std::endl;
		}
	}
	Test_History << "------------------------------------------------- " << std::endl;
