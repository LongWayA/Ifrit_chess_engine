...
)
{
	...
	//std::cout << "sizeof(Hash_moves) = " << sizeof(struct Hash_moves) << "\n";
	...
	// TEST
	//std::cout << "sizeof(Hash_moves) = " << sizeof(Hash_moves) << "\n";
...
// TEST
	...
	//std::cout << " в итоге выделили памяти в мб = " << ((int)(max_index_hash + 3) * sizeof(Hash_moves))/(1024 * 1024) << "\n";
	//std::cout << "размер элемента в байтах sizeof(Hash_moves) = " << sizeof(Hash_moves) << "\n";
...
)
{
	...
	*/
	...
	if (p_hash_moves == NULL) 
	{
		std::cout << "Transposition_table::look_hash_score_white  p_hash_moves == NULL " << "\n";
		exit(1); 
	}
...
)
{
	...
	if (p_hash_moves == NULL) 
	{
		std::cout << "Transposition_table::look_hash_score_black  p_hash_moves == NULL " << "\n";
		exit(1); 
	}
...
)
{
	...
	if (p_hash_moves == NULL) 
	{
		std::cout << "Transposition_table::look_hash_move  p_hash_moves == NULL " << "\n";
		exit(1); 
	}
...
)
{
	...
	*/
	...
	if (p_hash_moves == NULL) 
	{
		std::cout << "Transposition_table::save_best_hash_move  p_hash_moves == NULL " << "\n";
		exit(1); 
	}
...
)
{
	...
	if (p_hash_moves == NULL) 
	{
		std::cout << "Transposition_table::save_hash_move  p_hash_moves == NULL " << "\n";
		exit(1); 
	}
...
)
{
	...
	*/
	...
	if (p_hash_moves == NULL) 
	{
		std::cout << "Transposition_table::save_best_hash_score  p_hash_moves == NULL " << "\n";
		exit(1); 
	}
...
)
{
	...
	if (p_hash_moves == NULL) 
	{
		std::cout << "Transposition_table::save_hash_score  p_hash_moves == NULL " << "\n";
		exit(1); 
	}
...
void Transposition_table::TEST_Hash_index_print()
{
	...
	if (p_hash_moves == NULL) 
	{
		std::cout << "Transposition_table::TEST_Hash_index_print  p_hash_moves == NULL " << "\n";
		exit(1); 
	}
...
//TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
		...
		Test_Hash << "hash_moves[].move_delta_depth " << hash_moves[ind].move_delta_depth << "\n";
		//Test_Hash << "key "<< key <<"\n";
		Test_Hash << "hash_moves[].key " << hash_moves[ind].key_lock_32_move << "\n";
		Test_Hash << "hash_moves[].move "<< move_print <<"\n";

		//------------------------------------------
		Test_Hash << "Ходящая фигура " << UTIL::public_int_to_char_board(((move_print>>24)& 7),1)<< "\n";
		Test_Hash << "hash_moves[].score_move " << hash_moves[ind].score << "\n";
