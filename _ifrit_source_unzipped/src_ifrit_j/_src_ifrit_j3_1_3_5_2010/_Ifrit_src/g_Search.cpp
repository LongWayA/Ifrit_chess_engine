...
p_bitboard->hash_key = key_undo;
   ...
   // ищем лучшую позицию. за белых ищем максимум
      if (value > value_max){
        ...
        //       std::cout << "Ходящая фигура " << util_o.int_to_char_board(((list_surplus_moves.move[i]>>24)& 7),1)<< "\n";
        //       
...
//-----------------------------------------------
	  ...
	  if ( ZOBRIST::Analysis_hash_string_moves(depth) ){
        // у нас получился вариант приводящий к данной позиции и плюс оценка этой позиции
        if(flag_pv_f) PVSAVE::Update_PV_best_max_depth(0 // оценка ничья
			                                             ,depth);
		return 0;
...
*/
  ...
  std::cout << "ход из хеш таблицы " << "\n";
               ...
               std::cout << "Ходящая фигура " << UTIL::int_to_char_board(((list_surplus_moves.move[0]>>24)& 7),1)<< "\n";
...
std::cout << "hash_moves_test12= " << hash_moves_test13  << "\n";
               ...
               std::cout << "Ходящая фигура " << UTIL::int_to_char_board(((list_surplus_moves.move[hash_moves_test13]>>24)& 7),1)<< "\n";
