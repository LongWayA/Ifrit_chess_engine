...
}// inline void List_capture_white(int name,int type_move,int & from,int & to,int & count,const struct T_p_bitboard * p_bitboard,struct T_list_surplus_moves * p_list_surplus_moves){
//	*******************************************************************
...
count = count + 1;
}// inline void List_capture_black(int name,int type_move,int & from,int & to,int & count,const struct T_p_bitboard * p_bitboard,struct T_list_surplus_moves * p_list_surplus_moves){
//	*******************************************************************
...
p = p + 1;
}// inline void List_record_sp(int name,int d_m,int & p,int & from,int to,int capture,struct T_list_surplus_moves * p_list_surplus_moves){
//	*******************************************************************
...
#if KONTROL_B
///////////////////////////////////////////////////////////////////////////////////
if ((*p_p < 0)||(*p_p > 256))   std::cout << "ERROR Generator_captures p= "   << *p_p    << "\n";
if ((*p_from < 0)||(*p_from > 63)) std::cout << "ERROR Generator_captures from= " << *p_from << "\n";
if ((*p_to < 0)||(*p_to > 63))     std::cout << "ERROR Generator_captures to= "  << *p_to   << "\n";
if ((p_bitboard->white_name_from_coord[*p_from] < 1)||(p_bitboard->white_name_from_coord[*p_from] > 6))     std::cout << "ERROR Generator_captures p_bitboard->white_name_from_coord[*from] = "  << p_bitboard->white_name_from_coord[*p_from]   << "\n";
if ((p_bitboard->black_name_from_coord[*p_to] < 1)||(p_bitboard->black_name_from_coord[*p_to] > 6)){
	std::cout << "ERROR Generator_captures p_bitboard->black_name_from_coord[*p_to]= "  << p_bitboard->black_name_from_coord[*p_to]   << "\n";
    std::cout << "ERROR Generator_captures from= "<< *p_from << "\n";
    std::cout << "ERROR Generator_captures to= "  << *p_to   << "\n";
    std::cout << "ERROR Generator_captures name_figure= "  << name_figure << "\n";
    Bitboard_print(p_bitboard);
}//if ((p_bitboard->black_name_from_coord[*to] <1)||(p_bitboard->black_name_from_coord[*to]>6)){
//if (p_bitboard->black_name_from_coord[*to] ==6) std::cout << "ERROR Generator_captures name_figure KING "  << "\n";
///////////////////////////////////////////////////////////////////////////////////
#endif//KONTROL_B
}//void KONTROL(){
//	*******************************************************************
...
if ((*p_from < 0)||(*p_from > 63)) std::cout << "ERROR Generator_captures from= " << *p_from << "\n";
if ((*p_to < 0)||(*p_to > 63))     std::cout << "ERROR Generator_captures to= "  << *p_to   << "\n";
if ((p_bitboard->black_name_from_coord[*p_from] < 1)||(p_bitboard->black_name_from_coord[*p_from] > 6))     std::cout << "ERROR Generator_captures p_bitboard->black_name_from_coord[*p_from] = "  << p_bitboard->black_name_from_coord[*p_from]   << "\n";
if ((p_bitboard->white_name_from_coord[*p_to] < 1)||(p_bitboard->white_name_from_coord[*p_to] > 6)){
	std::cout << "ERROR Generator_captures p_bitboard->white_name_from_coord[*p_to]= "  << p_bitboard->white_name_from_coord[*p_to]   << "\n";
    std::cout << "ERROR Generator_captures from= "<< *p_from << "\n";
    std::cout << "ERROR Generator_captures to= "  << *p_to   << "\n";
    std::cout << "ERROR Generator_captures name_figure= "  << name_figure << "\n";
    Bitboard_print(p_bitboard);
}//if ((p_bitboard->white_name_from_coord[*to] <1)||(p_bitboard->white_name_from_coord[*to]>6)){
//if (p_bitboard->white_name_from_coord[*to] ==6) std::cout << "ERROR Generator_captures name_figure KING "  << "\n";
///////////////////////////////////////////////////////////////////////////////////
#endif//KONTROL_B
}//void KONTROL(){
//	*******************************************************************
...
#if KONTROL_B
///////////////////////////////////////////////////////////////////////////////////
if ((*p_p < 0)||(*p_p > 256))   std::cout << "ERROR Generator_move p= "   << *p_p    << "\n";
if ((*p_from < 0)||(*p_from > 63)) std::cout << "ERROR Generator_move from= " << *p_from << "\n";
if ((*p_to < 0)||(*p_to > 63))     std::cout << "ERROR Generator_move to= "  << *p_to   << "\n";
///////////////////////////////////////////////////////////////////////////////////
#endif//KONTROL_B
}//void KONTROL(){
//	*******************************************************************
...
}// __inline intBit_scan_forward_win32(unsigned __int64 analyzed_number){ 
//	*******************************************************************
...
}// __inline int Bit_scan_reverse_win32(unsigned __int64 analyzed_number){ 
//	*******************************************************************