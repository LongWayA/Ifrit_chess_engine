...
char UTIL::int_to_char_board(const int i,// код фигуры
...
// 0-нет фигуры, 1-пешка, 2-конь, 3-слон, 4-ладья, 5-ферзь, 6-король	
int UTIL::char_to_int_board(const char f// символ фигуры
					        ){
...
char UTIL::x_to_notation(const int x//горизонтальная координата доски (0-7)
				         ){
