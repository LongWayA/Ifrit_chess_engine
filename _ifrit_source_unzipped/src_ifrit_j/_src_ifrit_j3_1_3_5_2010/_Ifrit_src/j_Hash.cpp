...
if ((hash_n & (hash_n - 1)) != 0) std::cout << "ЗАСАДА! размер не вида степени двух " << hash_n << "\n";
...
// кэшируем лучший на данный момент ход
 void HASHM_private::Save_best_hash_move(unsigned __int8 i,// номер хода по списку
...
//	===================================================================
// кэшируем лучший на данный момент ход 
 void HASHM_private::Save_hash_move(unsigned __int8 i,// номер хода по списку
						   unsigned __int32 key_lock_32,//
						   struct T_list_surplus_moves * p_list_surplus_moves,// список ходов
						   unsigned __int8 delta_depth,// глубина записи хода
                           unsigned __int32 ind//   
...
// если ход нашелся то flag_insert_hash_move 2 иначе флаг 1
 void HASHM_private::Insert_hash_moves(struct T_list_surplus_moves * p_list_surplus_moves,// список ходов
...
//------------------------------------------
     Test_Hash << "Ходящая фигура " << UTIL::int_to_char_board(((move_print>>24)& 7),1)<< "\n";
 ...
 //25 - взятие с превращением в ферзь 
     ...
     Test_Hash << "Взятая фигура " << UTIL::int_to_char_board(( move_print & 63),1)<< "\n";
