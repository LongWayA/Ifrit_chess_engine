...
//---------------------------------------------------------------------------
//
inline void King_pst(const T_Bitboard * p_bitboard,// представление доски
...
//---------------------------------------------------------------------------
//
inline void Pawn_pst(const T_Bitboard * p_bitboard,// представление доски
                           unsigned __int8 & from_white_king,// расположение белого короля
                           unsigned __int8 & from_black_king,// расположение черного короля
                           unsigned __int16 stadia_w, // сумарный вес фигур у белых
                           unsigned __int16 stadia_b, // сумарный вес фигур у черных
...
//---------------------------------------------------------------------------
//
inline void PST(const T_Bitboard * p_bitboard,// представление доски
                      unsigned __int8 from_white_king,// расположение белого короля
                      unsigned __int8 from_black_king,// расположение черного короля
...
//---------------------------------------------------------------------------
__inline __int32 Bit_scan_forward_win32(unsigned __int64 bm);

//---------------------------------------------------------------------------
__inline __int32 Bit_scan_reverse_win32(unsigned __int64 bm);
...
const unsigned __int16 rubikon = QUEEN + ROOK;//рубеж перехода в эндшпиль(две ладьи и слон и пешка)1600
