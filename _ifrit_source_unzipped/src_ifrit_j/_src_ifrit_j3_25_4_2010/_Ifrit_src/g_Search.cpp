...
list_surplus_moves.sorting_score[i] = -1000000;
  ...
  // ставим флаг что есть легальные ходы и засчитываем позицию
	...
	//sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss
	    ...
	    // обновляем хеш ключ
	    HASHM::Modification_random_key(1,i,&list_surplus_moves,p_bitboard,undo);
...
//----------------
        ...
        HASHM::Save_hash_three(p_bitboard->hash_key,new_depth);
...
list_surplus_moves.sorting_score[i] = 1000000;
	...
	//    обновляем хеш ключ
	      HASHM::Modification_random_key(0,i,&list_surplus_moves,p_bitboard,undo);
...
//    cout << "Eval_forced(p_bitboard)= "<< EVALUATE::Eval_forced(p_bitboard)<<"\n";
//    cout << "p_bitboard->eval= "<< p_bitboard->eval<<"\n";
