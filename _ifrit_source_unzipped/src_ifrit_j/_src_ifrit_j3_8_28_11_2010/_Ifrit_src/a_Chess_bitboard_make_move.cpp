...
void Chess_bitboard::public_onward_moves_white
(
	const unsigned __int8 & i,//номер хода по списку
	struct T_undo undo[],//информация для отката хода
	const class List_surplus_moves * const list_surplus_moves//список возможных ходов
)
{
...
void Chess_bitboard::public_onward_moves_black
(
	const unsigned __int8 & i,//номер хода по списку
	struct T_undo undo[],//информация для отката хода
	const class List_surplus_moves * const list_surplus_moves//список возможных ходов
...
//	===================================================================
// ход назад для белых
void Chess_bitboard::public_backs_moves_white
(
	const unsigned __int8 & i,//номер хода по списку
...
void Chess_bitboard::public_backs_moves_black
(
	const unsigned __int8 & i,//номер хода по списку
	const struct T_undo undo[],//информация для отката хода
	const class List_surplus_moves * const list_surplus_moves//список возможных ходов
