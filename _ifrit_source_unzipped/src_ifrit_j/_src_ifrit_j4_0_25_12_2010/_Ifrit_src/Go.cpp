...
)
{
	...
	ini_go_command(string_in,depth_max_go_command,wtime_go_command,btime_go_command
	...
	deepening(bitboard,depth_max_go_command,wtime_go_command,btime_go_command
		,winc_go_command,binc_go_command,movestogo_go_command
		,movetime_go_command,infinite_go_command);
...
(
	...
	__int8 & movestogo_go_command,//количество ходов на которое выделено время
	double & movetime_go_command,//время на ход
	bool & infinite_go_command//бесконечный анализ
)
{
	__int16 find;
	__int16 find_w;
