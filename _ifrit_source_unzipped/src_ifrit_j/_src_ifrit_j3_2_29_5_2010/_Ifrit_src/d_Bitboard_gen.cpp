...
)
{
	...
	while (captures_mask != 0 )
	{
		if (p_bitboard->black_name_from_coord[bit_scan_forward_win32(captures_mask)] == N_KNIGHT)
			return N_KNIGHT;
	...
	while (captures_mask != 0)
	{
		if (p_bitboard->black_name_from_coord[bit_scan_forward_win32(captures_mask)] == N_KING)
			return N_KING;
...
)
{
	...
	while (captures_mask != 0)
	{
		if (p_bitboard->white_name_from_coord[bit_scan_forward_win32(captures_mask)] ==  N_KNIGHT)
			return N_KNIGHT;
	...
	while (captures_mask != 0)
	{
		if (p_bitboard->white_name_from_coord[bit_scan_forward_win32(captures_mask)] == N_KING)
			return N_KING;
...
)
{
	...
	///////////////////////////////////////////////////////////////////////////////////
	if ((*p_p < 0)||(*p_p > 256))
		std::cout << "ERROR Generator_captures p= "   << *p_p    << "\n";
	...
	if ((p_bitboard->white_name_from_coord[*p_from] < 1)||(p_bitboard->white_name_from_coord[*p_from] > 6))
		std::cout << "ERROR Generator_captures p_bitboard->white_name_from_coord[*from] = "  
	...
	{
		std::cout << "ERROR Generator_captures p_bitboard->black_name_from_coord[*p_to]= " 
...
)
{
	...
	if ((p_bitboard->black_name_from_coord[*p_from] < 1)||(p_bitboard->black_name_from_coord[*p_from] > 6))
		std::cout << "ERROR Generator_captures p_bitboard->black_name_from_coord[*p_from] = "
	...
	{
		std::cout << "ERROR Generator_captures p_bitboard->white_name_from_coord[*p_to]= "
