...
//TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
		...
		{
			if(p_hash_moves[ihm].key_lock_32_move != -1)
				pozition = pozition + 1;
		}
...
void HASHM::TEST_Hash_index_print()
{
	...
	{
		if (p_hash_moves[cnt].key_lock_32_move != 0)
			yes_move = yes_move + 1 ;

		if (p_hash_moves[cnt].key_lock_32_score != 0)
			yes_score = yes_score + 1 ;
