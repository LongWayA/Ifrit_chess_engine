...
class List_surplus_moves _root_list_surplus_moves[1];// список возможных ходов (всевозможные ходы из данного узла)
...
//TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
	...
	class List_surplus_moves & root_list_surplus_moves = 
		_root_list_surplus_moves[0];// список возможных ходов (всевозможные ходы из данного узла)
