...
/*
 УРОВЕНЬ МОЕГО ДОВЕРИЯ 90%
  ...
  кроме тех что заданы в файле List_surplus_moves_const.h,  Evaluate_const.h
...
//------------------------------------------------------------------------------
// используем в Search.cpp Search_root.cpp
	...
	const __int32 FUTILITY_MARGIN[] = {150, 150, 200, 300, 1000};

	// RAZORING
	const __int32 RAZORING_MARGIN[] = {120, 120, 180, 200, 1000};
...
//------------------------------------------------------------------------------
// используем в Search_quiescence.cpp Search.cpp Search_root.cpp
...
//------------------------------------------------------------------------------
// используем в Chess_bitboard_delta_pruning.cpp
