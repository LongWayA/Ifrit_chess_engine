...
)
{
	...
	std::cout <<x_to_notation(((list_surplus_moves.get_move(i)>>12)& 63)%8);
	std::cout <<(1 + ((list_surplus_moves.get_move(i)>>12)& 63)/8);
	std::cout <<x_to_notation(((list_surplus_moves.get_move(i)>>18)& 63)%8);
...
__int8 PV_save::int_to_char_board
(
