...
void Chess_bitboard::onward_moves_white
(
...
void Chess_bitboard::onward_moves_black
(
	const unsigned __int8 & i,//номер хода по списку
	struct Undo undo[],//информация для отката хода
	const class List_surplus_moves * const list_surplus_moves//список возможных ходов
...
//	===================================================================
// ход назад для белых
void Chess_bitboard::backs_moves_white
(
	const unsigned __int8 & i,//номер хода по списку
...
void Chess_bitboard::backs_moves_black
(
	const unsigned __int8 & i,//номер хода по списку
	const struct Undo undo[],//информация для отката хода
	const class List_surplus_moves * const list_surplus_moves//список возможных ходов
