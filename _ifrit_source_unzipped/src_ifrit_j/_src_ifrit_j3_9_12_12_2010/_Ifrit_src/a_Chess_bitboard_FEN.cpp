...
(
	__int8 string_in[]//входящая строка(65536)
)
{
	// инициализирующая позицию строка может быть трех видов 
	//"position startpos" просто начальная позиция
	...
	__int8 * fen;  //
	__int8 * moves;//
	__int8 * ptr;  // вспомогательный указатель
	__int8 move_string[]={' ',' ',' ',' ',' ',' ',' '};// вспомогательный массив
	__int8 * StartFen = "fen rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1 ";// стартовая фен-позиция
...
(
	const __int8 fen[]//строка содержащая фен позицию(длинна переменная)
)
{
